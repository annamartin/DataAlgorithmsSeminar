 ...
 */
public class SimpleMlpNodeView extends NodeView<SimpleMlpNodeModel> {
     ...
     */
    public SimpleMlpNodeView(final SimpleMlpNodeModel model) {
        super(model);
    ...
    protected void modelChanged() {
        SimpleMlpNodeModel model = getNodeModel();
