 ...
 * @since 3.0
 */
public class SimpleMlpNodeFactory extends NodeFactory<SimpleMlpNodeModel> {
    /**
     * {@inheritDoc}
     */
    @Override
    public NodeDialogPane createNodeDialogPane() {
        return new SimpleMlpNodeDialog();
    }
     ...
     */
    @Override
    public SimpleMlpNodeModel createNodeModel() {
        return new SimpleMlpNodeModel();
    }
